...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(()=>_profileController.loading.value?const CustomPageLoading():
         SingleChildScrollView(
          ...
          child: Column(
            children: [
               ...
               Center(
                child: CustomNetworkImage(imageUrl:_profileController.profileData.value.data!.info!.imageurl!, height: 150, width:150,boxShape: BoxShape.circle,),

              ),

              SizedBox(height:20.h,),
              Text(_profileController.profileData.value.data!.info!.name!,style: const TextStyle(fontWeight:FontWeight.w600,fontSize: 16),),
              SizedBox(height:8.h,),
              Text(_profileController.profileData.value.data!.info!.email!),
              SizedBox(height:8.h,),
              Text(_profileController.profileData.value.data!.info!.username!),
