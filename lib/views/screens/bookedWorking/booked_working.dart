...
class _BookedWorkingState extends State<BookedWorking> {
  ...
  BookedWorkingController _bookedWorkingController =
                      ...
                      children: [
                        ...
                        _bookedWorkingController
                            ...
                            ? Container(
                                ...
                                child: Text("Dieser Monat wurde am ${_bookedWorkingController
                                    .bookedWorkData.value.data!.finalization!.createdAt} abgeschlossen und kann nicht mehr verändert werden."),
                              )
                            : _bookedWorkingController.bookedWorkData.value
                                ...
                                ? ElevatedButton(
                                    onPressed: () {
                                      ...
                                      showDialog(context: context, builder: (_)=>CompleteMonthDialog());
                                    },
                                    style: ElevatedButton.styleFrom(
                                        backgroundColor:
                                            AppColors.primaryColor,
                                        textStyle: const TextStyle(color: AppColors.white)),
                                    child: Text("month_complete".tr,style:const TextStyle(color: AppColors.white) ,),
                                  )
                                : SizedBox(),
                        ...
                        if (_bookedWorkingController
                            .bookedWorkData.value.data!.entries!.isEmpty)
                          SizedBox(
                            height: 200.h,
                          ),
                        ...
                        _bookedWorkingController
                            ...
                            ? Center(
                                child: Text(
                                    "no_booked_working_hours_available".tr))
                            : Expanded(
